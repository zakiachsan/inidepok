      ...
      <div className="flex items-center justify-between h-12 px-4">
        ...
        <div className="hidden md:flex flex-1 max-w-sm">
          <div className="relative w-full">
            <input
              type="text"
              placeholder="Cari..."
              className="w-full pl-8 pr-3 py-1.5 text-sm border border-gray-300 rounded-md focus:ring-1 focus:ring-primary-500 focus:border-red-500"
            />
            <svg
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            ...
            >
              <div className="w-6 h-6 bg-primary-600 rounded-full flex items-center justify-center text-white font-bold text-xs">
              ...
              <>
                ...
                <div className="absolute right-0 mt-1 w-44 bg-white rounded-md shadow-lg border border-gray-200 z-20">
                  <div className="p-2 border-b border-gray-100">
                    ...
                    <span className="inline-block mt-1 px-1.5 py-0.5 bg-primary-100 text-primary-700 text-[10px] rounded">
                      {user.role}
                    </span>
                  </div>
                  <div className="p-1">
                    ...
                    <button
                      ...
                      className="w-full text-left px-2 py-1.5 text-xs text-primary-600 rounded hover:bg-primary-50"
                    >
                      Keluar
                    </button>
                  </div>
